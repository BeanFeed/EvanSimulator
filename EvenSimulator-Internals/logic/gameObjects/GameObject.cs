using EvenSimulator_Internals.logic;
using System;
...
namespace EvanSimulator.logic
{
    public class GameObject
    {
        ...
        public GameObject(Game game, string spriteFile, PointF position)
        {
            setup(
                game,
        ...
        public GameObject(Game game, Dictionary<string, string> spriteFiles, PointF position)
        {
            setup(
                game,
                spriteFiles,
        ...
        private void setup(Game game, Dictionary<string, string> spriteFiles, PointF position) {
            this.game = game;
